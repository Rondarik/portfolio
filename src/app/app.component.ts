...
import { OverlayMenuComponent } from './main-page/overlay-menu/overlay-menu.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterOutlet, MainPageComponent, HeaderComponent, OboutMeComponent, MySkillsComponent,PortfolioComponent,ContactComponent, OverlayMenuComponent],
